package com.corbellini.accounts.constants;

public class AccountConstants {

  private AccountConstants() {} // block constructor to avoid inserting business logic

  public static final String SAVINGS = "Savings";
  public static final String ADDRESS = "123 Street, Brazil";
